        ...
        <div class="whole-checkout">
            <div class="whole-container">
                <div class="upper-box">
                        ...
                        <h4 class="package-subtext">One-time payment only.</h4>
                        <div class="packages">
                            ...
                            <div class="packages-section" >
                                ...
                                <div class="paybutton-container">
                                <a href="https://buy.stripe.com/cN27sP3H5eaq1gY4gk" class="paybutton-middle">Select</a>
                                </div>
                            </div>
...
$(document).ready(function(){
    setTimeout(function() {
        $('a[href^="https://buy.stripe.com/"]').each(function(){
            var oldBuyUrl = $(this).attr("href"); // Get current url
            var referralId = Rewardful.referral;
            var newBuyUrl = oldBuyUrl + "?client_reference_id=" + referralId; // Create new url
